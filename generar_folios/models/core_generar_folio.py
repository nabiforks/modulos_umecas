...
class CoreGeneradorFolios(models.Model):
    ...
    tipo_folio_id = fields.Many2one('core_formato_folio',
    ...
    def getFolio(self, par_prefijo_folio):
        ...
        if coreFolio:
            ...
            print " ------ >>>> Error --->>>"
            raise ValueError('Error no se a suministrado un tipo de folio correcto')
        """
            Implementar la creación de folios genericos....
            self.createGenericFolio(par_par_prefijo_folio) 
        """
        return folio
    ...
    def createGenericFolio(self, prefijo):
        pass
        # comenzar aqui....
